-- 20240201_fix_create_booking_loop.sql
--
-- Fix: FOREACH .. IN ARRAY cannot consume a set-returning function.
-- Use a plain FOR .. IN SELECT loop over jsonb_array_elements instead.
...
begin
  ...
  return query select b.booking_number, b.status from bookings b where b.id = v_booking_id;
end;
$$;